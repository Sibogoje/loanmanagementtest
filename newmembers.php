...
if (isset($_POST['submit']) ) {
    ...
    $insert = $conn->prepare("INSERT INTO `members` (`name`, `surname`, `gender`, `email`, `phone`, `postal`, `national_id`, `password`, `home_address`, `current_address`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $insert->bind_param("ssssssssss", $name, $surname, $gender, $email, $phone, $postal, $national_id, $password, $home, $current);
    $insert->execute();
    $insert->close();
