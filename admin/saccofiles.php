...
if (!file_exists($file_path)) {
    ...
    if (!in_array($extension, ['zip', 'pdf', 'docx', 'png', 'jpg', 'jpeg', 'doc'])) {
        ...
        if (move_uploaded_file($file, $file_path.'/'.$filename)) {
            $sql = "INSERT INTO saccofiles ( `name`, `purpose`, `dateupload`, `view`) VALUES ('$filename', '$purpose', '$dates', '$view')";
            if (mysqli_query($conn, $sql)) {
                header('Location: saccofiles.php');                
            }
        } else {
    ...
    <hr style="margin-bottom: 1px">
      ...
      <div class="col-md-4">
                  <div class="form-floating mb-3">
                    <select name="purpose" class="form-select" id="purpose" aria-label="Loan" required>
                    ...
                    <label for="delivery">Purpose</label>
                  </div>
                </div>
                ...
                <div class="text-center col-xs-12 col-lg-12" style="margin-top: 8px; margin-bottom: 8px;">
                  <button type="submit" name="submit" class="btn btn-primary col-12 col-lg-12" style="background-color: #d63600;">Upload Document</button>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td> <button type='submit' title='View' data-id='' data-link='saccofiles/".$row['name']."'  class='btn btn-success'><i class='bi bi-eye'></i></button>
