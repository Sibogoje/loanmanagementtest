...
<div class="card shadow-lg">
  <div class="card-body">
    <h5 class="card-title">Statement Files</h5>
    ...
    <hr style="margin-bottom: 1px">
                ...
                <div class="col-md-4">
                  <div class="form-floating mb-3">
                    <select name="month" class="form-select" id="month" aria-label="Loan" required>
                    ...
                    <label for="delivery">For Which Month</label>
                  </div>
                </div>
                ...
                <div class="text-center col-xs-12 col-lg-12" style="margin-top: 8px; margin-bottom: 8px;">
                  <button type="submit" name="submit" class="btn btn-primary col-12 col-lg-12" style="background-color: #d63600;">Upload Statement</button>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td> <button type='submit' title='View' data-id='' data-link='statements/".$row['owner']."/".$row['name']."'  class='btn btn-success'><i class='bi bi-eye'></i></button>
