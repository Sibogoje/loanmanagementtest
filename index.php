...
if ($stmt = $conn->prepare('SELECT `id`, `password` FROM `members` WHERE `email` = ?')) {
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class=" d-lg-block" style="color: #d63600;">Umcenge User</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="credits" style="color: #d63600;">
                ...
                Designed by <a href="https://liquag.com/">Siboniso Sibandze</a>
              </div>
