...
if (isset($_POST['submit']) ) {
   ...
   // $income = $_POST['income'];
    ...
    $statement->bind_param("sssssssssssssssssss", $uid, $loandates, $net, $add_income_source, $add_income, $total_income, $rent, $mortgage, $utilities, $schoolFees, $transport, $otherloan, $otherexpenses, $total_expenses, $delivery, $amount, $type, $interest, $status);
