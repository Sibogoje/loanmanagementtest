...
if (!file_exists($file_path)) {
    ...
    if (!in_array($extension, ['zip', 'pdf', 'docx', 'png', 'jpg', 'jpeg', 'doc'])) {
        ...
        if (move_uploaded_file($file, $file_path.'/'.$filename)) {
            $sql = "INSERT INTO loanfiles (`owner`, `name`, `dateupload`, `reason`) VALUES ('$idd','$filename', '$dates', '$reason')";
            if (mysqli_query($conn, $sql)) {
                header('Location: loanfiles.php');                
            }
        } else {
...
<div class="card shadow-lg">
  <div class="card-body">
    <h5 class="card-title">Loan Files</h5>
    ...
    <hr style="margin-bottom: 1px">
                ...
                <div class="col-md-6">
                  <div class="form-floating mb-3">
                    <select name="reason" class="form-select" id="reason" aria-label="Loan" required>
                      ...
                      <option value = "Expense Proof">Expense Proof</option>
                ...
                <div class="text-center col-xs-12 col-lg-12" style="margin-top: 8px; margin-bottom: 8px;">
                  <button type="submit" name="submit" class="btn btn-primary col-12 col-lg-12" style="background-color: #d63600;">Upload Loan Support Document</button>
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM loanfiles WHERE owner = '$id' ORDER BY id DESC";
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td> <button type='submit' title='View' data-id='' formtarget='_blank' data-link='uploads/".$row['owner']."/".$row['name']."'  class='btn btn-success'><i class='bi bi-eye'></i></button>
